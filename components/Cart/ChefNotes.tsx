export const ChefNotes = () => {
  return (
    <div className='mt-8'>
      <label className='text-xs font-semibold text-muted-foreground mb-4 block uppercase tracking-widest'>
        Забелешка до шефот на кујна
      </label>
      <div className='relative group'>
        <textarea
          ...
          placeholder='Специфични алергии или желби при подготовка...'
        />
