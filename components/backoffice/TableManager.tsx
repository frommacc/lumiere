...
import {
  saveTableAction,
  saveTableTypeAction,
} from '@/actions/backoffice/tables'
    ...
    <div className='grid gap-4 rounded-xl border border-outline-variant/20 bg-surface-container-low/50 p-5 xl:grid-cols-2'>
      ...
      >
        <div className='space-y-1.5'>
          <Label htmlFor='table-number'>Broj na masa</Label>
          <Input id='table-number' name='number' placeholder='M11' required />
        </div>
        <div className='space-y-1.5'>
      ...
      <form
        onSubmit={submitType}
        className='grid gap-3 sm:grid-cols-[1fr_1fr_1.3fr_auto] sm:items-end'
      >
        <div className='space-y-1.5'>
          <Label htmlFor='table-type-name'>Tip na masa</Label>
          <Input
            id='table-type-name'
            name='name'
            placeholder='Terasa'
        ...
        <div className='space-y-1.5'>
          <Label htmlFor='table-type-description'>Opis</Label>
          <Input
            id='table-type-description'
            name='description'
            placeholder='Otvorena terasa'
          />
        </div>
