  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        <p className='text-sm text-on-surface-variant'>          Total tables:{' '}
      ...
      {tables.length === 0 ? (
        <div className='rounded-xl border border-dashed border-outline-variant/30 p-8 text-center text-sm text-on-surface-variant'>          No tables entered.
        </div>
      ) : (
